  ...
  if (true) {
    ...
    */
    ...
    var ignorable = null;
    var browser = jQuery("#smartwrap-browser").get(0);
    ...
    var logP = Math.log(0.99);
    var logO = Math.log(0.6);
    ...
    var dialogs = jQuery("#dialog_templates .dialog_template");
    ...
    jQuery(document).bind("showSidebar", function(event) {
      setTimeout(function() {
        var reqConsent = Smartwrap.getSetting('requestConsent');
        var consent = Smartwrap.getSetting('consent');
